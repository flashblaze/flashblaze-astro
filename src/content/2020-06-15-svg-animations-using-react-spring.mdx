...
import BasicAnim from '/posts/svg-animations-using-react-spring/4_circle_basic_animation.mp4';
import AdvancedAnim from '/posts/svg-animations-using-react-spring/5_circle_advanced_animation.mp4';
...
![Default React app](/posts/svg-animations-using-react-spring/1_default_react_app.png)
...
![Hello World!](/posts/svg-animations-using-react-spring/2_hello_world.png)
...
![SVG Circle](/posts/svg-animations-using-react-spring/3_svg_circle.png)
