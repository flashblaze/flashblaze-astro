...
<Picture
  src='/posts/gatsby-to-astro/1_gatsby_vercel_build_times.jpg'
...
<Picture
  src='/posts/gatsby-to-astro/2_astro_announcement.jpg'
...
<Picture
  src='/posts/gatsby-to-astro/3_redesigned_website.jpg'
...
<Picture
  src='/posts/gatsby-to-astro/4_astro_vercel_build_times.jpg'
  alt='Redesigned website'
  widths={[1200]}
  sizes='1200px'
  aspectRatio={2}
...
For now, yeah. I'm quite happy with the current setup and who know, instead of switching to another framework and **then** writing a post on it, I might just write one for the heck of it.
