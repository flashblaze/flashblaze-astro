...
![Console Image](/posts/real-time-post-views/1_console.png)

2. Navigate to Develop -> Database and click on "Create Database"
3. Choose "Start in Test Mode"

![Database Image](/posts/real-time-post-views/2_database.png)

4. Choose your location and click on "Done"
5. Click on "Project Settings".

![Go To Project Settings Image](/posts/real-time-post-views/3_go_to_project.png)

6. Click on web icon to create a "Web App"

![Project Settings Image](/posts/real-time-post-views/4_settings.png)

7. Enter your name. I'll name mine **react-gatsby-views-app**. Do not enable Firebase hosting and click on "Register app"

![Register App Image](/posts/real-time-post-views/5_register.png)

8. Click on "Continue to console" as we'll need the config object later

![Continue to Console Image](/posts/real-time-post-views/6_continue_to_console.png)

9. Go to "Database" and select "Realtime Database"

![Selecting Realtime Database Image](/posts/real-time-post-views/7_select_realtime.png)
...
![Change Rules Image](/posts/real-time-post-views/8_change_rules.png)
...
![Choose Web App Image](/posts/real-time-post-views/9_web_app.png)

2. Scroll down to Your apps and and copy the `firebaseConfig` object.

![Config Object Image](/posts/real-time-post-views/10_config.png)
...
![Error Image](/posts/real-time-post-views/11_error.png)
...
![App Success Image](/posts/real-time-post-views/12_success.png)

Firebase Views

![Firebase Success Image](/posts/real-time-post-views/13_success_fb.png)
