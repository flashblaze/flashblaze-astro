...
<Picture
  src='/public/post-assets/svg-animations-using-react-spring/1_default_react_app.png'
...
```
<Picture
  src='/public/post-assets/svg-animations-using-react-spring/2_hello_world.png'
  alt='Hello World!'
/>
...
```
<Picture
  src='/public/post-assets/svg-animations-using-react-spring/3_svg_circle.png'
  alt='SVG Circle'
/>
