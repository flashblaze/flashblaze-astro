...
As of this writing, the website takes about 10 seconds to load when loaded for the first time. I think this is due to the cold start of the Turso DB. I have yet to find a solution to this though 🥲. One solution is to keep the DB "hot" by making API calls at a certain intervals which I don't plan on doing.

# What's next?

Right now, I'm in the process of migrating to [Cloudflare D1](https://developers.cloudflare.com/d1/). Below are the D1 specific links:
...
<div class='flex items-center gap-2'>
  <Icon
    ...
    title='Website'
  />
  <a href='https://d1-map.flashblaze.dev/' target='_blank'>
    D1 MapViz
  </a>
</div>
...
<div class='flex items-center gap-2'>
  <Icon
    ...
    title='GitHub'
  />
  <a href='https://github.com/flashblaze/map/tree/d1' target='_blank'>
